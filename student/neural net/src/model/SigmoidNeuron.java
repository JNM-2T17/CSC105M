...
public class SigmoidNeuron extends Neuron {
	/**
	 * Constructs a new sigmoid neuron with the given learning rate. It 
	 * also sets whether this neuron is an output neuron.
	 * @param isOutput whether this neuron is an output neuron
	 * @param learningRate learning rate
	 */
	public SigmoidNeuron(int id,boolean isOutput, double learningRate) {
		super(id,isOutput,learningRate);
	}

	/**
	 * Constructs a new sigmoid neuron with the given learning rate and 
	 * momentum. It also sets whether this neuron is an output neuron.
	 * @param isOutput whether this neuron is an output neuron
	 * @param learningRate learning rate
	 * @param momentum momentum of this neuron
	 */
	public SigmoidNeuron(int id,boolean isOutput,double learningRate,double momentum) {
